DEVELOPER: Replace occurrences of FranzPortable in this file with the
...
user in an INI file next to FranzPortable.exe called FranzPortable.ini.
...
copy AppNamePortable.ini from this directory to FranzPortable.ini next to
FranzPortable.exe. The options in the INI file are as follows:
